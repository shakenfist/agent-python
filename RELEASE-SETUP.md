...
2. Navigate to your project: `shakenfist-agent`
...
**Note**: If the `shakenfist-agent` package already exists on PyPI under a
different publishing method, you can add the trusted publisher alongside the
...
1. Go to the repository on GitHub: `shakenfist/agent-python`
...
1. A maintainer pushes a tag matching `v*` (e.g., `v0.6.0`)
